        ...
        <div className="card mb-5 mb-lg-0">
          <div className="card-body">
            ...
            <ul className="fa-ul">
              ...
              <li className= {props.data.dedicatedPhoneSupportEnabler?"":"text-muted"}><span className="fa-li"><i className={props.data.dedicatedPhoneSupportEnabler?"fas fa-check":"fas fa-times"}></i></span>{props.data.phoneSupport}</li>
